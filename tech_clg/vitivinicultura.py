...
class Vitivinicultura:
    def __init__(self):
        ...
        self.files = {
            ...
            'file_t': ['ProcessaAmericanas.csv', 'ProcessaMesa.csv'],
        }

        self.file_sep = {'file_dot_comma': ';', 'file_t': '\t'}
    ...
    def get_last_updated_date(
        ...
        html = getAndParseURL(self.url_date)
        ...
        if match:
            ...
            modified_date = datetime.datetime(
                year=int(year) + 2000, month=int(month), day=int(day)
            )
